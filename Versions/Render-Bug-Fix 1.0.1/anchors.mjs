...
Object.prototype.render=function(page,args){
    if(typeof page=="object"){
        this.textContent="";
        page.querySelectorAll("[anchor]").forEach((i)=>{i.removeAttribute("anchor")});
        this.append(page.cloneNode(true))
    }else if (typeof page=="function"){
        this.textContent="";
        let pages=page(args);
        pages.querySelectorAll("[anchor]").forEach((i)=>{i.removeAttribute("anchor")});
        this.append(pages)
    }
}
