            ...
            attrnames.forEach((i)=>{
                if(i[0]=="$"&&typeof list[e.getAttribute(i)]){
                    ...
                    case "model":
                        ...
                        content.addEventListener(updateSeed,updateModel)
                        document.addEventListener(updateSeed,updateModel);
                    ...
                    case "class":
                        ...
                        content.addEventListener(updateSeed,updateClass)
                        document.addEventListener(updateSeed,updateClass)
...
const diff=(first,second,confirmed)=>{
    ...
    const classDiff=(st,nd)=>{
        if(st.className!=nd.className){
            st.className=nd.className
        }
    }
